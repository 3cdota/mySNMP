...
namespace MIB.Controllers
{
    public class SNMPController : Controller
    {
        ...
        {
			string[] args = new string[] { "192.168.56.110", "public", "1.3.6.1.2.1.2.2" };

			return View(SNMP(args));
			
        }

        public static Dictionary<string, Dictionary<uint, AsnType>> SNMP(string[] args)
		{
			if (args.Length != 3)
			{
			...
			// Keep looping through results until end of table0
		...
		public static Dictionary<Oid,AsnType> Walk(string host,string community,string[] coloums )
        {
